                        ...
                        <div className="header-menu">
                            <div className="header-left">
                                ...
                                <div className="dropdown for-notification">
                                    ...
                                    <div className="dropdown-menu d-none" aria-labelledby="notification">
                                ...
                                <div className="dropdown for-message">
                                    ...
                                    <div className="dropdown-menu d-none" aria-labelledby="message">
                                        <p className="red">You have 4 Mails</p>
                                        <a className="dropdown-item media" href="#">
                                            <span className="photo media-left"><img alt="avatar" src={ImagesPath.avatar1} /></span>
                            ...
                            <div className="user-area dropdown float-right">
                                <a href="#" className="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img className="user-avatar rounded-circle" src={ImagesPath.adminJpg} alt="User Avatar" />
                                </a>

                                <div className="user-menu dropdown-menu right-0">
